...
const Desktop = () => {
  ...
  return (
    <ParticlesWallpaper>
      <main 
        className="h-screen w-screen p-4 pb-12 overflow-hidden relative bg-transparent z-10"
      ...
      >
        {showIntroText && (
          <div className="absolute inset-0 flex flex-col items-center justify-center z-20 pointer-events-none animate-pulse">
            <h1 className="text-4xl md:text-6xl font-sans font-bold text-white/80 tracking-widest text-center">
              PORTFÓLIO INTERATIVO
            </h1>
            <p className="text-xl md:text-2xl font-sans text-white/60 tracking-wider mt-2">
              IMERSIVO
            </p>
          </div>
        )}
        ...
        <div className="h-full w-full flex flex-col items-start flex-wrap content-start">
          ...
          <DesktopIcon
            ...
            onClick={(e) => { e.stopPropagation(); setSelectedIcon('whatsapp'); }}
            textColor="text-white"
          />
        </div>
